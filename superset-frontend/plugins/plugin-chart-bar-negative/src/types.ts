...
export interface BarNegativeFormData extends QueryFormData {
  dimension: string;
...
export interface BarNegativeSeries {
  name: string;
  values: number[];
}

export interface BarNegativeTransformedProps {
  width: number;
  height: number;
  categories: string[];
...
export type BarNegativeChartProps = ChartProps<BarNegativeFormData>;
