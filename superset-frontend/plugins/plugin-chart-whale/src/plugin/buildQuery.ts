...
/**
 * The buildQuery function is used to create the query that will be passed to the API
 * The function receives the formData, which contains the information about the chart
